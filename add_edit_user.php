...
<h1 class="h3 mb-4 text-gray-800"><b><u><i>ADD NEW USER</b></u></i>
    <a class="btn btn-primary float-right" href="users.php"><b><u><i>Back</b></u></i></a>
</h1>
...
<form action="<?php site_url("add_edit_user.php"); ?>" method="post">
    <div class="row">
        ...
        <div class="card">
                ...
                <div class="card-body">
                    <button type="submit" class="btn btn-primary"><b><u><i>Save</b></u></i></button>
                    <button type="reset" class="btn btn-secondary"><b><u><i>Clear</b></u></i></button>
                    <button type="reset" class="btn btn-danger"><b><u><i>Delete</b></u></i></button>
